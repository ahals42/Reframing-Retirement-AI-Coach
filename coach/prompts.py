...
- When mentioning any scheduled activity (classes, drop-ins, groups), always add a brief note that schedules can change and they should check the app or contact the organizer directly before heading out.
